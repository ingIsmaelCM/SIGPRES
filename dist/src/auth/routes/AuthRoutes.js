...
class AuthRoutes extends BaseRoutes_1.default {
    ...
    initRoutes() {
        ...
        this.router.put("/profile/:id", AuthMiddleware_1.default.auth, InfoRequest_1.default.relatedInfoRequest(), InfoRequest_1.default.validate, (req, res) => this.controller.updateAuthInfo(req, res));
