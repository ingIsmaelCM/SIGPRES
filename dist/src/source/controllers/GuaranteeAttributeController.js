...
const AttributeService_1 = __importDefault(require("@source/services/AttributeService"));
class AttributeController extends Controller_1.default {
    prefix = 'attributes';
    ...
    async delete(req, res) {
        return this.safeRun(async () => this.mainService.deleteAttribute(req.params.id), res, 200, "");
    }
    async restore(req, res) {
        return this.safeRun(async () => this.mainService.restoreAttribute(req.params.id), res, 200, "");
    }
}
...
], AttributeController.prototype, "store", null);
__decorate([
    Controller_1.setAuthor,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
